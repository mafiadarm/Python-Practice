...
from m23sw_all.settings import USER_AGENT as au_list
import random


class M23SwAllSpiderMiddleware(object):
...
class M23SwAllDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
